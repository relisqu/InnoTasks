...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def test_register_user(self):
        self.assertTrue(self.database.register_user("test_user",
                                                    "password123"))
        self.assertFalse(
            self.database.register_user("test_user", "password123")
    ...
    def test_authenticate_user(self):
        self.database.register_user("test_user", "password123")
        self.assertTrue(self.database.authenticate_user("test_user",
                                                        "password123"))
        self.assertFalse(self.database.authenticate_user("test_user",
                                                         "wrong_password"))
